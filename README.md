...
A basic web app using flash, containerized with Docker deployed to Kubernetes, with infrastructure created using CI/CD using Github Actions
...
Accessing locally at http://localhost:8888
